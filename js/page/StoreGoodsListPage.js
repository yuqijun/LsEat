...
//     // 屏幕第一个为激活的分组
//     var concurrentGroup = changed.viewableItems[0].item.title;
...
//           <View  style={{ width:leftSideWidth,height:height-170} }>
//               <FlatList
    ...
    var rightSideTextWidth = rightSidiWidth-120-15;
      ...
      return(
        ...
        <View style={{flex:1,width:width,flexDirection:"row",flexWrap:'wrap'}}>
          {/* 左侧商品分组FlastList */}
          {/* <View  style={{ width:leftSideWidth,borderWidth:0.1,borderColor:'#D3D3D3',height:height-170} }> */}
          <View  style={{ width:leftSideWidth,height:height-225} }>
              <FlatList
              showsVerticalScrollIndicator = {false}
              ref = 'leftScroll'
              keyExtractor = {this._left_extraUniqueKey}
          ...
          {/* 右侧商品FlastList */}
          <View style={{width:width*(4/5),height:height-225,backgroundColor:'white'}}>
              <FlatList 
            ref = 'rightScroll'
            alwaysBounceHorizontal = {false}
            overScrollMode = {'never'}
      ...
      <View style={{width:width,height:40,shadowColor: "black",zIndex:2,backgroundColor:'white',marginTop:-28}}>
